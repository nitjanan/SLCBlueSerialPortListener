...
namespace SerialPortListener
{
    public partial class ucReport : UserControl
    {
        ...
        public void setautoCompleteCustomer(string fieldId, string fieldName, string tableName, ComboBox cbb, List<string> listOriginal)
        {
            ...
            pgCommand.CommandText = "SELECT " + fieldName + " , " + fieldId + " FROM public." + tableName + " WHERE weight_type = 1 or weight_type = 3 or base_vat_type_id = '01' ORDER BY  base_vat_type_id, " + fieldId;
            try
            {
                dl.connect();
        ...
        private void setDataWeightToDTGV()
        {
            try
            {
                ...
                sql.Append("SELECT *  FROM public.weight WHERE วันที่ >= '" + tbdateFrom.Value.ToString("yyyy-MM-dd") + "' AND  วันที่ <= '" + tbdateTo.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ORDER BY วันที่, เลขที่เอกสาร");
        ...
        private void btPrint_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + tbdateFrom.Value.ToString("yyyy-MM-dd") + "' AND '" + tbdateTo.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ORDER BY วันที่, เลขที่เอกสาร";
        ...
        private void btPrintScoop_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromScoop.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToScoop.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ";
            if (tbScoopName.Text != "")
        ...
        private void btPrintJointCar_Click(object sender, EventArgs e)
        {
            ...
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromJointCar.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToJointCar.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ";
        ...
        private void btPrintInvoice_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromInvoice.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToInvoice.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ";
        ...
        private void btPrintCustomer_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromCustomer.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToCustomer.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ";
        ...
        private void btPrintClean_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromClean.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToClean.Value.ToString("yyyy-MM-dd") + "' AND ล้าง = '" + getRadioValueClean() + "' AND bws LIKE '%V' ORDER BY วันที่, เลขที่เอกสาร ";
        ...
        private void btPrintMill_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromMill.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToMill.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ";
        ...
        private void btPrintSite_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromSite.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToSite.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ORDER BY วันที่, เลขที่เอกสาร ";
        ...
        private void btPrintStoneType_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromStoneType.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToStoneType.Value.ToString("yyyy-MM-dd") + "' AND NOT น้ำหนักรวม = 0.00 AND NOT คิว = 0.00 AND NOT โรงโม่ = ' ' AND NOT รหัสลูกค้า LIKE '10%' AND (NOT site_id = '300PL' OR site_id IS NULL) AND bws LIKE '%V' ";
        ...
        private void btPrintTransport_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromTransport.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToTransport.Value.ToString("yyyy-MM-dd") + "' AND bws LIKE '%V' ORDER BY วันที่, เลขที่เอกสาร ";
        ...
        private void btPrintTransportByTeam_Click(object sender, EventArgs e)
        {
            //sql
            dl.connect();
            string sql = "select * from weight where วันที่ BETWEEN '" + dtFromTransportByTeam.Value.ToString("yyyy-MM-dd") + "' AND '" + dtToTransportByTeam.Value.ToString("yyyy-MM-dd") + "' AND NOT รหัสลูกค้า = '09-A-001' AND NOT รหัสลูกค้า = '09-V-001' AND bws LIKE '%V' ";
